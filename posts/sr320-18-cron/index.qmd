...
::: {.callout-tip appearance="minimal" icon="false"}
```         
0 7 * * * /home/shared/8TB_HDD_03/sr320/github/ghr.sh > /home/shared/8TB_HDD_03/sr320/github/ghr$
```
:::
...
**But as I was writing this post copilot finished my sentence to tell me to add `sleep` comnmand**
:::
