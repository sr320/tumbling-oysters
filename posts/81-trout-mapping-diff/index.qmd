...
Lean and siscowet lake trout are two ecotypes of the same species that look and behave differently --- siscowet are deep-water, fat-rich fish; lean are shallower-water and leaner. Earlier work in this project ([21.1](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/code/21.1-gene-anchored-synteny.Rmd)) matched up genes between the two ecotypes and the reference genome, one gene at a time. That tells us *which* genes correspond to each other, but not *how the genome itself has been rearranged* --- whether whole chunks of DNA have flipped around, moved to a different chromosome, or been duplicated. That's what this step, described in full in [23.1-genome-sv-map.Rmd](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/code/23.1-genome-sv-map.Rmd), is for.
...
-   Feed the confirmed SVs into the genome browsers alongside the gene-anchored synteny tracks ([22-synteny-browser-integration](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/code/22-synteny-browser-integration.qmd)), so a rearrangement and the genes inside it can be viewed together.
