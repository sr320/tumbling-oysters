...
We know that genotype and epigenetic patterns are primarily responsible for phenotype, yet there is a lack of understanding to what degree the two are linked. Here we characterized the degree by which genetic variation and DNA methylation variation are coupled in a marine invertebrate and identified potential mechanisms, _with almost a third of the methylation variation attributable to genotype._ This means **2/3 of methylation is not attributable to genotype**.
