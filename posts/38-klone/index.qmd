...
In summary, this configuration directs R to install and access packages from a custom directory rather than the system-wide library, which is especially useful in shared or containerized environments.
