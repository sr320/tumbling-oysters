...
-   Genes present in **lean but not siscowet** --- [lean_only.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-gene-sets/lean_only.tsv) (5,058 genes)
-   Genes present in **siscowet but not lean** --- [siscowet_only.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-gene-sets/siscowet_only.tsv) (9,589 genes)
-   **Copy-number differences** between the ecotypes --- [cnv.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-gene-sets/cnv.tsv) (2,359 genes) --- and [shared.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-gene-sets/shared.tsv) for contrast
...
-   **Read-based ecotype-specific genes** (genes inside regions genuinely uncovered by the *other* ecotype's sequencing reads, a different signal than annotation) --- [lean_specific.genes.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-reciprocal-pav/lean_specific.genes.tsv) and [siscowet_specific.genes.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-reciprocal-pav/siscowet_specific.genes.tsv). A gene appearing here **and** in the gene-set list above is the strongest case.
-   **Everything joined** --- one row per gene with all six evidence flags and an `n_lines` count: [two_genome_candidates.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-integration/two_genome_candidates.tsv) (≥2 lines incl. a native line) and the full [gene_evidence_matrix.tsv](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-integration/gene_evidence_matrix.tsv). The re-run enrichment results, including the calcium-vs-lipid test, are in [analyses/23-integration/](https://gannet.fish.washington.edu/v1_web/owlshell/bu-github/project-lake-trout/analyses/23-integration/).
