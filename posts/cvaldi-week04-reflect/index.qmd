...
Gleason, L. U., and R. S. Burton. 2015. RNA-seq reveals regional differences in transcriptome response to heat stress in the marine snail Chlorostoma funebralis. Molecular Ecology 24:610–627.
 <https://doi.org/10.1111/mec.13047>.
:::
...
Morin, M., M. Jönsson, C. K. Wang, D. J. Craik, S. M. Degnan, and B. M. Degnan. 2023. Captivity induces a sweeping and sustained genomic response in a starfish. Molecular Ecology:mec.16947.
  <https://doi.org/10.1111/mec.16947>.
:::

Here the authors report the inability of a species of wild-caught starfish to acclimate to the stress that comes with captivity by describing the distinct differences in the transcriptome of wild versus captive individuals. As they are evaluating the transcriptomic profiles of wild and formerly-wild starfish, it can be said that the molecular marks of chronic stress expressed by the formerly-wild starfish.

Thus, the concept of adaptation is not necessarily mutually exclusive from their findings since it is on a shorter genetic time scale.

- not that different though because the others almost refer to a population level ability of reaching adaptation or tolerance to stressors
- my paper is focused on the same individuals, of course they are not able to successfully merge into the captive environment as normal as there is not transmision of genes that would promote tolerance 
