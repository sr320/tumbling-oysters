...
## Note (2025-04-04 11:45:33)

https://maps.app.goo.gl/xquX6v3QoEw5BTDc7

## Note (2025-03-29 13:29:28)

https://pmc.ncbi.nlm.nih.gov/articles/PMC11938993/

## Note (2025-03-04 06:59:36)

| 62-7174 | CLIMATE RESILIENCE | CC100950 CoEnv | Aquatic and Fishery Sciences (SAFS) - R&E | PG107267 | GR014587 | FD200 | RS100077 | FN111 |

## Note (2025-03-01 11:45:01)

Get the Peve time series methylation array, stuff in a notebook

## Note (2025-03-01 08:14:36)

Run deep expression on symbiont

## Note (2025-02-28 12:40:04)

https://gannet.fish.washington.edu/spartina/project-oyster-oa/Haws/

## Note (2025-02-28 07:40:26)

One thing that I really want to get done, let's put it on a to do item and maybe if we search for to do it'll come up, but I'd like to develop some research retrospective to come up on my website to look at kind of past effort and and summarize in particularly if we're not there, they're not active areas you know I'm thinking Olympia oyster I just changed that I'm also thinking active efforts to might be might be valued #todo

\<!— block assistant —\> Develop a research retrospective section on my website:

1.  Plan where to incorporate the section on the website, consider where it can be easily accessed and seen.
2.  Begin to gather and compile the information for past projects, focusing on non-active ones like the Olympia oyster.
3.  Write thorough summaries of each project, detailing the process, findings, and why the project ended or is currently inactive.
4.  Design the website section to be engaging and easy to understand.
5.  Build out ‘active efforts’ section as well, keeping it updated with current projects and research.
6.  Once the section is ready, test for usability and functionality.
7.  Upload and monitor the performance of the new section.
8.  Consider promoting the new section through various channels to ensure it catches the attention of site visitors.

This could be a great way to showcase past achievements and pursuits. It could also aid in sparking interest in currently active projects. #todo \<!— endblock —\>

## Note (2025-02-28 06:36:47)

Goal today is getting e5 lncrna discovery pipeline up.

## Note (2025-02-25 16:45:09)

My Afternoon

```         
•   I met with the research administration team to discuss my grants
•   I need to carefully manage my budgets for grants ending this summer
•   I’m still waiting to hear back from NSF about a no-cost extension
•   I’m having some challenges finding postdocs to hire
•   Around 3:15 PM, I had a discussion about my course and research
•   We talked about the effectiveness of online vs. in-person recitations
```

## Note (2025-02-25 16:25:35)

Today I did not do much coding- class stuff and admin meetings

## Note (2025-02-24 20:05:58)

I am done for now

## Note (2025-02-24 19:51:44)
